...
<div x-data="{{ json_encode(['show' => true, 'style' => $style, 'message' => $message]) }}"
            ...
            :class="{ 'bg-success-500': style == 'success', 'bg-danger-500': style == 'danger', 'bg-gray-500': style != 'success' && style != 'danger' }"
            style="display: none;"
            x-show="show && message"
    ...
    <div class="max-w-screen-xl px-3 py-2 mx-auto sm:px-6 lg:px-8">
        <div class="flex flex-wrap items-center justify-between">
            <div class="flex items-center flex-1 w-0 min-w-0">
                <span class="flex p-2 rounded-lg" :class="{ 'bg-success-600': style == 'success', 'bg-danger-600': style == 'danger' }">
